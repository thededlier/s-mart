    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 ">
                    <p style="padding:20px;"></p>
                    <h2 align="center" class="colonel">Services</h2>
                </div>
            </div>
                        <br>
                          <br>
       ...
       <div class="container">
           <div class="row">
               <div class="col-xs-12 col-sm-4">
                   <div class="panel panel-primary">
                       <div class="panel-heading">
                           <h3 class="panel-title">Product Comparison</h3>
                       </div>
                       <div class="panel-body">
                           <h4>Product Comparison details will come here.</h4>
                       </div>
                   </div>
               </div>
               ...
               <div class="col-xs-12 col-sm-4">
                   <div class="panel panel-primary">
                       <div class="panel-heading">
                           <h3 class="panel-title">Product History</h3>
                       </div>
                       <div class="panel-body">
                           <h4>Product History details will come here.</h4>
                       </div>
                   </div>
               </div>
               ...
               <div class="col-xs-12 col-sm-4">
                   <div class="panel panel-primary">
                       <div class="panel-heading">
                           <h3 class="panel-title">Price Compare</h3>
                       </div>
                       <div class="panel-body">
                           <h4>Price Compare Details will come here.</h4>
                       </div>
                   </div>
               </div>
           </div>
       ...
       <div class="container">
           <div class="row">
               <div class="col-xs-12 ">
                   <p style="padding:20px;"></p>
                   <h2 align="center" class="colonel">Our Vision</h2>
               </div>
           </div>
       </div>
       <div class="container">
           <div class="row">
               <div class="col-xs-12 ">
                   <p style="padding:20px;"></p>
                   <p class="major">We aim to build a web platform which is designed for the purpose of continious monitoring of price fluctuations of products marketed by online vendors such as Flipkart, Amazon, Snapdeal etc by providing data visualisation.To encourage users for further smart shopping we will be adding more features soon. </p>
               </div>
           </div>
           <br><br>
           <div class="container">
               <div class="row">
                   <div class="col-xs-12">
                       <!-- slide show of screenshots showing functionalities will come here -->
                   </div>
               </div>
           </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12">
                     ...
                     <!-- User's feedback will come here -->
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-6 col-sm-5">
                    <h5>Our Address</h5>
                    <address>
                        G-306 Abode Valley<br>
                        Kakkan Street,Potheri<br>
                        <br>
                        CHENNAI -603203<br>
                        <i class="fa fa-phone"></i>: +919176045101<br>
                        <i class="fa fa-fax"></i>: +919791492498<br>
                        <i class="fa fa-envelope"></i>:
                        <a href="smartbazaar@gmail.com">smartbazaar@gmail.com</a>
                    </address>
                </div>
                <div class="col-xs-12 col-sm-4">
                    <div  class="nav navbar-nav"style="padding: 40px 10px;">
                        ...
                        <a class="btn" href="mailto:"><i class="fa fa-envelope-o"></i></a>
                    </div>
                </div>
                <div class="col-xs-12">
                    <p style="padding:10px;"></p>
                    <p align="center">© Copyright 2017 S-MART BAZAAR</p>
                </div>
            </div>
        </div>
    </footer>
